"""
Django settings for lively_disk_41765 project.
...
ROOT_URLCONF = 'lively_disk_41765.urls'
...
WSGI_APPLICATION = 'lively_disk_41765.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "lively_disk_41765 API",
    "DESCRIPTION": "API documentation for lively_disk_41765 App",
    "VERSION": "v1",
}
